...
- [RhinoSecurityLabs/cloudgoat](https://github.com/RhinoSecurityLabs/cloudgoat) — vulnerable AWS
...
- [aquasecurity/kube-hunter](https://github.com/aquasecurity/kube-hunter) — study K8s attack surface (lab only)
