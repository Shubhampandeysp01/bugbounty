...
- [redcanaryco/atomic-red-team](https://github.com/redcanaryco/atomic-red-team) — ATT&CK-mapped tests (authorized labs)
- [LOLBAS-Project/LOLBAS](https://github.com/LOLBAS-Project/LOLBAS)
- [GTFOBins](https://gtfobins.github.io/)
- Study for blue-team detection engineering; only use techniques in isolated labs
